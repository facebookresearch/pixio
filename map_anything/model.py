...
from map_anything.geometry import (
    apply_log_to_norm,
...
from map_anything.inference_utils import (
...
from map_anything.encoders.dense_rep_encoder import DenseRepresentationEncoder
from map_anything.encoders.global_rep_encoder import GlobalRepresentationEncoder
from map_anything.encoders.pixio_encoder import PixioEncoder
from map_anything.info_sharing.alternating_attention_transformer import (
    MultiViewAlternatingAttentionTransformerIFR,
)
from map_anything.info_sharing.base import MultiViewTransformerInput
from map_anything.prediction_heads.adaptors import (
    CamTranslationPlusQuatsAdaptor,
    RayDirectionsPlusDepthWithConfidenceAndMaskAdaptor,
    ScaleAdaptor,
)
from map_anything.prediction_heads.base import (
    AdaptorInput,
    PredictionHeadInput,
    PredictionHeadLayeredInput,
    PredictionHeadTokenInput,
)
from map_anything.prediction_heads.dpt import DPTFeature, DPTRegressionProcessor
from map_anything.prediction_heads.mlp_head import MLPHead
from map_anything.prediction_heads.pose_head import PoseHead
...
class MapAnything(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(
        ...
        self.encoder = PixioEncoder(**encoder_config_copy)
        ...
        self.ray_dirs_encoder = DenseRepresentationEncoder(**ray_dirs_encoder_config)
        ...
        self.depth_encoder = DenseRepresentationEncoder(**depth_encoder_config)
        ...
        self.depth_scale_encoder = GlobalRepresentationEncoder(**depth_scale_encoder_config)
        ...
        self.cam_rot_encoder = GlobalRepresentationEncoder(**cam_rot_encoder_config)
        ...
        self.cam_trans_encoder = GlobalRepresentationEncoder(**cam_trans_encoder_config)
        ...
        self.cam_trans_scale_encoder = GlobalRepresentationEncoder(**cam_trans_scale_encoder_config)
    ...
    def _initialize_info_sharing(self, info_sharing_config):
        ...
        ## self.info_sharing_return_type == "intermediate_features":
    ...
    def _encode_n_views(self, views):
        ...
        encoder_input = ViTEncoderInput(
            image=all_imgs_across_views, data_norm_type=views[0]["data_norm_type"][0]
        )
