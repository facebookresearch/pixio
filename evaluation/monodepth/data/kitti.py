...
class KITTI(Dataset):
    def __init__(self, data_root, mode, input_size=None):
        ...
        with open(f'monodepth/splits/kitti/{mode}.txt', 'r') as f:
    ...
    def __getitem__(self, item):
        ...
        # img_path = os.path.join('/checkpoint/data-h100-2/liheyang/data/kitti', img_path)
        # depth_path = os.path.join('/checkpoint/data-h100-2/liheyang/data/kitti/train', depth_path)
